...
import com.anjian.jiuxiao.service.FireFighting.TimeLimitService;
...
//        String PROCESS_DECISION = request.getParameter("PROCESS_DECISION");
        ...
        responseText = timeLimitService.createTimeLimitTable(TIME_IDS,EXECUTE_PEOPLE2,CARD_NUMBER2,CHECKE_UNIT, EXECUTE_PEOPLE,CARD_NUMBER,CHECKE_DETAIL,checkUnit,RECORD_ID);
        return responseText;
    }
    /**
     * 上传执法者签名
