...
import com.anjian.jiuxiao.service.FireFighting.TimelyRectificationService;
...
//    }
    ...
    public void setInspectionRecord(HttpServletRequest request){
        ...
        timelyRectificationService.setInspectionRecord(PROCESS_DECISION,CHECKE_DETAIL,CHECKE_UNIT,CHECKED_START_TIME,checkUnit,RECORD_ID);
    }
    /**
     * 上传执法者签名
     */
