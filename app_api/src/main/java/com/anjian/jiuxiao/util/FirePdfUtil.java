...
public class FirePdfUtil {
    ...
    public static String createPdfNoSign(String folderName,String CHECKED_UNIT,String CHECKE_UNIT,String CHECK_PEOPLE,String CHECK_START_TIME,String CHECK_ITEM,String CHECK_DESC,String CHECK_IMG,String unit,String id){
        String qu = "";
        String street = "";
        if(unit.contains("区")){
